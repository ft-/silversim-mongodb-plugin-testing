...
namespace SilverSim.Tests.Preconditions.MongoDB
{
    ...
    public sealed class ResetDatabase : IPlugin, IDBServiceInterface
    {
        private static readonly ILog m_Log = LogManager.GetLogger("MONGODB RESET DATABASE");
        private readonly string m_ConnectionString;
        private readonly string m_DatabaseName;

        public ResetDatabase(IConfig config)
        {
        ...
        public void VerifyConnection()
        {
            ...
            {
                collections.Add(item["name"].ToString());
            }
